...
namespace LiveClinic.Consultation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo {Title = "LiveClinic.Consultation", Version = "v1"});
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "LiveClinic.Consultation v1"));
            }
            ...
            EnsureMigrationOfContext<ConsultationDbContext>(app);
            Log.Information($"LiveCLINIC.Consultation [Version {GetType().Assembly.GetName().Version}] started successfully");
        }
